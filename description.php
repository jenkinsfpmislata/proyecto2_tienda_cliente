...
<?php
	...
	$SQL="SELECT * FROM producto WHERE idProducto=2";
...
<div id="contenido" style="height: 1130px">
...
<!-- FIN MEJORES PRODUCTOS -->

<div id="descripcionProductoNuevo">

    <h4 class="modeloProducto"><b>
            <?php
            echo $fila["marca"];
            ?> <?php
            echo $fila["Nombre"];
    ...
    <div class="productoTienda">
        <img src="imagenes/imagenesProductos/<?php
             echo $fila["Imagen"];
             ?>.jpg">
    </div>
    ...
    <div class="detallesProducto">
        ...
        <div id="caracteristicas">
            <h4><i><b>Features:</b></i></h5>
                <li>Operative System: Windows 8</li>
                <li>Processor: Intel Pentium I7</li>
                <li>Graphic Card: </li>
                <li>Storage: 250GB</li>
        </div>
        ...
        <input type="button" class="btn btn-success" id="anadirCarrito" onClick="" value="Añadir al carrito" />
