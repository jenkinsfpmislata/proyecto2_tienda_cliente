            ...
            function anyadirCarrito(id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        datos = datos + '<div class="producto"><p id="precioLista">' + data[index].precio + ' &euro;</p><img id="imgProd" src="imagenes/imagenesProductos/' + data[index].Imagen + '.jpg"><div id="descripcion"><p>' + data[index].Nombre + '<br>' + data[index].Descripcion + '</p></div></div><div class="cerrar"><img src="imagenes/imagenesStatic/close.png" onclick=""></div>';
