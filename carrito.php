             ...
             $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            datos +='</tbody><tfoot><tr><td colspan="4">Total:3000<span class="glyphicon glyphicon-euro"></span></td><td><a id="cont" class="btn btn-default btn-sm">Continue</a></td></tr></tfoot></table>';
